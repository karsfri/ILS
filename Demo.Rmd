...
Bæta má öðrum liðum við plottið með því `+` virkjanum. Það fyrsta sem er yfirleitt bætt við er *geometry* sem er safn af föllum sem byrja öll á *geom_* og svo er nafninu á viðkomandi *geom* bætt við. Hér hefur verið bætt við *column*.

Ath! Hér virkar *color = "pink"* ekki því að það er búið að skrifa yfir default argumentin með *theme_set_ils*.
...
Einnig er hægt að setja *mappings* í *geom* föllunum, en það er yfirleitt aðeins gert ef að .
