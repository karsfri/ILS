...
Þá er einnig hægt að hafa fleira en eitt geom:
...
Búið er að útbúa nýtt *theme* fyrir HMS. Auðvelt er að bæta því við:
...
pop_tidy %>% 
  ...
  geom_point() +
  theme_hms() +
  theme(axis.text.x = element_text(family = "Setimo", face = "italic"))
```
